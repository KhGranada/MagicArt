        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header row">
                    <div class="col-sm-6 text-left">Registro de usuarios</div>
                    <div class="col-sm-6 text-right text-md-end"><a href="login">Ya tengo una cuenta</a></div>
                </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="type" class="col-md-4 col-form-label text-md-end">Seleccione tipo de usuario</label>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            <label for="name" class="col-md-4 col-form-label text-md-end">Dirección</label>
                            <div class="col-md-6">
