            ...
            <div class="row">
              <div class="col-4">
                <div class="form-group">
                  ...
                  <select name="customer_name" class="form-control" id="customer_name" required="required">
              ...
              <table class="table"
                ...
                <tbody>
                  <tr class="cloning_row"
                    ...
                    <td>
                      <input type="number"
                        step="0.01" name="row_sub_total[0]" id="row_sub_total" class="row_sub_total form-control" readonly="readonly">
                ...
                <tfoot>
                  ...
                  <tr>
                    ...
                    <td><input type="number"
                        step="0.01" name="vat_value" id="vat_value" class="vat_value form-control" readonly="readonly"></td>
                  </tr>
                  <tr>
                    <td colspan="3"></td>
                    <td colspan="2">{{ __('Frontend/frontend.shipping') }}</td>
                    <td><input type="number" step="0.01" name="shipping" id="shipping" value="0" class="shipping form-control"></td>
                  </tr>
                  <tr>
                    <td colspan="3"></td>
