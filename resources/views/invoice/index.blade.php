              ...
              @foreach ($invoices as $invoice)
                <tr>
                  ...
                  <td class="d-flex">
                    ...
                    {{-- DELETE ACTION --}}
                    <a href="javascript:void(0)" class="btn btn-danger btn-sm" onclick="if (confirm('confirme para eliminar')){document.getElementById('delete-{{ $invoice->id }}').submit();} else{return false}">
