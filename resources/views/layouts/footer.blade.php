...
<footer class="text-center text-lg-start bg-light text-muted col-sm-12 col-xs-12 position-relative" style="bottom:0">
    ...
    <div class="container text-center text-md-start mt-5">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <p>
            <a href="#!" class="text-reset">Empresas</a>
          </p>
          <p>
        ...
        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
          ...
          <p><i class="fas fa-home me-3"></i> Calle 26 sur # 48 -158 </p>
          <p>
            <i class="fas fa-envelope me-3"></i>
            info@magicart.com
          </p>
          <p><i class="fas fa-phone me-3"></i> + 57 3315522</p>
        </div>
        <!-- Grid column -->
      </div>
      <!-- Grid row -->
  ...
  <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">
    ...
    <a class="text-reset fw-bold" href="#">Magic Art - Arte y Diseño</a>
  </div>
  <!-- Copyright -->
</footer>
<!-- Footer -->