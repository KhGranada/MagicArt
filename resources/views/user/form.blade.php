<div class="box box-info padding-1">
    ...
    <div class="form-group">
            {{ Form::label('Tipo') }}
            {{ Form::text('type', $user->type, ['class' => 'form-control' . ($errors->has('type') ? ' is-invalid' : ''), 'placeholder' => 'Type' ,'readonly'=>'']) }}
        ...
        <div class="form-group">
            ...
            {{ Form::text('email', $user->email, ['class' => 'form-control' . ($errors->has('email') ? ' is-invalid' : ''), 'placeholder' => 'Email','readonly'=>'']) }}
            {!! $errors->first('email', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        @endif
        ...
        <div class="form-group">
            ...
            {{ Form::text('Cédula', $user->cedula, ['class' => 'form-control' . ($errors->has('cedula') ? ' is-invalid' : ''), 'placeholder' => 'Cedula']) }}
